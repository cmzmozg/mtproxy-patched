...
# ── DEBUG ────────────────────────────────────────────────────────────────────
import os as _os
DEBUG_MODE = _os.environ.get("MTPROXY_DEBUG", "0") == "1"

def dbg(msg):
    if DEBUG_MODE:
        ts = time.strftime("%H:%M:%S")
        print_err(f"[DBG {ts}] {msg}")
...
TG_DATACENTERS_V4 = [
    ...
    "149.154.167.91", "149.154.171.5",  # DC 1-5
    # DC 6-201: заглушки на DC2, реальные CDN-ноды недоступны напрямую
    "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51",
    "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51",
    "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51",
    "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51", "149.154.167.51",
    "149.154.167.99",  # DC 203 (idx=202) — Telegram CDN
]
...
def init_config():
    ...
    # === ИЗМЕНЕНИЕ 1: дефолтный порт 853 (DNS-over-TLS) вместо 3256 ===
    conf_dict.setdefault("PORT", 853)
    ...
    # ── MOD: Backup SOCKS5 для failover (второй xray outbound / другой провайдер) ──
    conf_dict.setdefault("SOCKS5_HOST_BACKUP", None)
    conf_dict.setdefault("SOCKS5_PORT_BACKUP", None)
    conf_dict.setdefault("SOCKS5_USER_BACKUP", None)
    conf_dict.setdefault("SOCKS5_PASS_BACKUP", None)
    ...
    # Реальный CDN IP для РФ обычно 91.105.192.100, НЕ 149.154.167.99 из старых таблиц.
    # Узнать свой: логи Telegram Desktop → grep "dc203"
    # Можно задать список: CDN_DC_IPS = {203: ["91.105.192.100", "149.154.167.99"]}
    conf_dict.setdefault("CDN_DC_IPS", {})
    ...
    # ── MOD: Увеличенные буферы для снижения syscall overhead через SOCKS5 chain ──
    conf_dict.setdefault("TO_CLT_BUFSIZE", (131072, 50, 1048576))
    conf_dict.setdefault("TO_TG_BUFSIZE", (131072, 50, 1048576))
...
async def _socks5_connect(host, port, socks_host, socks_port, socks_user=None, socks_pass=None):
    """Native asyncio SOCKS5 — does not block event loop unlike PySocks."""
    reader, writer = await asyncio.open_connection(socks_host, socks_port)
    try:
        # ── MOD: TCP_NODELAY на SOCKS5 сокете — убирает Nagle's 40-200ms задержку ──
        ...
        if sock:
            try:
                ...
                pass
        writer.write(b"\x05\x01\x00" if not (socks_user and socks_pass) else b"\x05\x01\x02")
        await writer.drain()
        resp = await reader.readexactly(2)
        if resp[0] != 5:
            raise ConnectionError(f"Bad SOCKS5 response: {resp}")
        if resp[1] == 2:
            creds = bytes([1, len(socks_user)]) + socks_user.encode() + bytes([len(socks_pass)]) + socks_pass.encode()
            writer.write(creds)
            await writer.drain()
            if (await reader.readexactly(2))[1] != 0:
                raise ConnectionError("SOCKS5 auth failed")
        elif resp[1] != 0:
            raise ConnectionError(f"SOCKS5 no auth method: {resp[1]}")
        host_b = host.encode() if isinstance(host, str) else host
        writer.write(bytes([5, 1, 0, 3, len(host_b)]) + host_b + port.to_bytes(2, "big"))
        await writer.drain()
        resp2 = await reader.readexactly(4)
        if resp2[1] != 0:
            raise ConnectionError(f"SOCKS5 CONNECT failed: {resp2[1]}")
        skip = {1: 6, 4: 18}.get(resp2[3])
        if skip:
...
# ── MOD: SOCKS5 с failover — race двух SOCKS5 серверов, берём первый ответивший ──
async def _socks5_connect_with_fallback(host, port):
    """Пробуем primary и backup SOCKS5 параллельно, берём быстрейший."""
    primary = asyncio.ensure_future(
        _socks5_connect(host, port, config.SOCKS5_HOST, config.SOCKS5_PORT,
                        config.SOCKS5_USER, config.SOCKS5_PASS)
    )

    if config.SOCKS5_HOST_BACKUP and config.SOCKS5_PORT_BACKUP:
        backup = asyncio.ensure_future(
            _socks5_connect(host, port, config.SOCKS5_HOST_BACKUP, config.SOCKS5_PORT_BACKUP,
                            config.SOCKS5_USER_BACKUP, config.SOCKS5_PASS_BACKUP)
        )
        ...
        for task in pending:
            task.cancel()
            # Закрываем соединение проигравшего
            try:
                r, w = task.result()
                w.close()
            except Exception:
...
def apply_upstream_proxy_settings():
    if config.SOCKS5_HOST and config.SOCKS5_PORT:
        msg = "Native asyncio SOCKS5 activated — non-blocking, uvloop compatible"
        if config.SOCKS5_HOST_BACKUP:
            msg += f" (backup: {config.SOCKS5_HOST_BACKUP}:{config.SOCKS5_PORT_BACKUP})"
        print_err(msg)
...
class TgConnectionPool:
    ...
    async def open_tg_connection(self, host, port, init_func=None):
        if config.SOCKS5_HOST and config.SOCKS5_PORT:
            # ── MOD: Используем fallback racing если есть backup SOCKS5 ──
            coro = _socks5_connect_with_fallback(host, port)
        else:
            coro = asyncio.open_connection(host, port, limit=get_to_clt_bufsize())
        reader_tgt, writer_tgt = await asyncio.wait_for(coro, timeout=config.TG_CONNECT_TIMEOUT)
        try:
            sock = writer_tgt.get_extra_info("socket")
            if sock:
                set_keepalive(sock)
                set_bufsizes(sock, get_to_clt_bufsize(), get_to_tg_bufsize())
                # ── MOD: TCP_NODELAY — убираем Nagle's задержку 40-200ms ──
                sock.setsockopt(socket.IPPROTO_TCP, socket.TCP_NODELAY, 1)
        except Exception:
            pass
        if init_func:
...
# =============================================================================
# ИЗМЕНЕНИЕ 2: Рандомизированный TLS ClientHello для обхода блокировки по
# фингерпринту (ТСПУ/РКН). Оригинальный метод имел фиксированный набор
# cipher suites и extensions — уникальную сигнатуру Telegram, которую ТСПУ
# научился детектировать и дропать. Новая версия генерирует ClientHello,
# неотличимый от реального Chrome/Firefox/Safari.
# =============================================================================

def _grease_value():
    """Генерирует случайное GREASE значение (RFC 8701).
    GREASE (Generate Random Extensions And Sustain Extensibility) — механизм
    Chrome для предотвращения окостенения TLS-стека. Настоящие браузеры всегда
    его включают, поэтому его наличие делает нас похожими на браузер."""
    # GREASE значения: 0x0A0A, 0x1A1A, 0x2A2A, ..., 0xFAFA
    idx = myrandom.randrange(16)
    val = (idx * 0x1010) + 0x0A0A
    return val.to_bytes(2, "big")


def gen_tls_client_hello_msg(server_name):
    """
    Генерирует TLS ClientHello с рандомизированным фингерпринтом.

    Что меняется по сравнению с оригиналом:
    1. GREASE в начале cipher suites и supported_groups — как у Chrome
    2. Порядок cipher suites перемешивается (shuffled)
    3. Случайный session ID (оригинал тоже рандомный, оставляем)
    4. Extensions идут в случайном порядке (кроме SNI — первый, padding — последний)
    5. Случайная длина padding вместо фиксированного выравнивания до 517 байт
    6. Случайный набор supported_groups (эллиптических кривых)
    7. Случайный набор signature_algorithms
    """
    server_name_bytes = server_name.encode("ascii")
    sn_len = len(server_name_bytes)

    # --- Случайные значения для этой сессии ---
    grease1 = _grease_value()      # GREASE для cipher suites
    grease2 = _grease_value()      # GREASE для supported_groups
    grease3 = _grease_value()      # GREASE для версий TLS
    session_id = myrandom.getrandbytes(32)
    client_random = myrandom.getrandbytes(32)

    # --- Cipher suites ---
    # Базовый набор — стандарт для современных браузеров
    base_ciphers = [
    ...
    # Перемешиваем порядок (кроме TLS 1.3 ciphers — они идут первыми у Chrome)
    tls13_ciphers = base_ciphers[:3]
    tls12_ciphers = base_ciphers[3:]
    myrandom.shuffle(tls12_ciphers)
    # GREASE идёт самым первым, затем TLS1.3, затем перемешанные TLS1.2
    cipher_list = [grease1] + [c for c in tls13_ciphers] + [c for c in tls12_ciphers]
    cipher_bytes = b"".join(cipher_list)
    # + стандартный SCSV (Signaling Cipher Suite Value)
    cipher_bytes += b"\x00\xff"  # TLS_EMPTY_RENEGOTIATION_INFO_SCSV (не всегда, но безопасно)
    ...
    # Chrome всегда включает x25519 и secp256r1, остальные — случайно
    must_have = all_groups[:2]
    optional = all_groups[2:]
    myrandom.shuffle(optional)
    # Берём 1-3 дополнительных кривых
    extra_count = myrandom.randrange(1, len(optional) + 1)
    chosen_groups = [grease2] + must_have + optional[:extra_count]
    groups_bytes = b"".join(chosen_groups)
    ...
    myrandom.shuffle(all_sig_algs)
    # Берём 5-9 алгоритмов
    sig_count = myrandom.randrange(5, len(all_sig_algs) + 1)
    chosen_sig_algs = all_sig_algs[:sig_count]
    sig_algs_bytes = b"".join(chosen_sig_algs)

    # --- Строим extensions ---
    # SNI (Server Name Indication) — всегда первый (стандарт)
    ext_sni = (
        b"\x00\x00" +  # extension type: server_name
        struct.pack("!H", sn_len + 5) +
        struct.pack("!H", sn_len + 3) +
        b"\x00" +
        struct.pack("!H", sn_len) +
        server_name_bytes
    )

    # Extended master secret
    ext_ems = b"\x00\x17\x00\x00"
    ...
    ext_groups = (
        b"\x00\x0a" +
        struct.pack("!H", len(groups_bytes) + 2) +
        struct.pack("!H", len(groups_bytes)) +
        groups_bytes
    )
    ...
    # Session ticket
    ext_ticket = b"\x00\x23\x00\x00"

    # ALPN (h2 + http/1.1)
    alpn_protocols = b"\x02h2\x08http/1.1"
    ext_alpn = (
        b"\x00\x10" +
        struct.pack("!H", len(alpn_protocols) + 2) +
        struct.pack("!H", len(alpn_protocols)) +
        alpn_protocols
    )

    # Status request (OCSP stapling)
    ext_status = b"\x00\x05\x00\x05\x01\x00\x00\x00\x00"

    # Signature algorithms
    ext_sig = (
        b"\x00\x0d" +
        struct.pack("!H", len(sig_algs_bytes) + 2) +
        struct.pack("!H", len(sig_algs_bytes)) +
        sig_algs_bytes
    )

    # Signed certificate timestamp
    ext_sct = b"\x00\x12\x00\x00"

    # Key share (x25519) — критически важно для TLS 1.3
    key_share_data = b"\x00\x1d\x00\x20" + gen_x25519_public_key()
    ext_keyshare = (
        b"\x00\x33" +
        struct.pack("!H", len(key_share_data) + 2) +
        struct.pack("!H", len(key_share_data)) +
        key_share_data
    )

    # PSK key exchange modes
    ext_psk_modes = b"\x00\x2d\x00\x02\x01\x01"

    # Supported versions (TLS 1.3 + GREASE)
    supported_versions = grease3 + b"\x03\x04\x03\x03\x03\x02\x03\x01"
    ext_versions = (
        b"\x00\x2b" +
        struct.pack("!H", len(supported_versions) + 1) +
        bytes([len(supported_versions)]) +
        supported_versions
    )

    # Compress certificate (RFC 8879) — есть у Chrome
    ext_compress = b"\x00\x1b\x00\x03\x02\x00\x02"

    # GREASE extension
    ext_grease = grease1 + b"\x00\x01\x00"

    # Собираем extensions в случайном порядке
    # SNI всегда первый, padding всегда последний, keyshare/versions — ближе к концу
    middle_exts = [
        ext_ems, ext_reneg, ext_groups, ext_ecpf, ext_ticket,
        ext_alpn, ext_status, ext_sig, ext_sct, ext_compress,
        ext_psk_modes, ext_grease,
    ]
    myrandom.shuffle(middle_exts)

    # Версии и keyshare должны быть перед padding — порядок важен для TLS 1.3
    ordered_exts = [ext_sni] + middle_exts + [ext_versions, ext_keyshare]

    extensions_body = b"".join(ordered_exts)

    # Padding — последний extension, выравниваем до случайной длины 400-512
    target_total = myrandom.randrange(400, 513)
    # Считаем текущий размер сообщения ТОЧНО
    # Формула: record_header(5) + handshake_type(1) + handshake_len(3) + 
    #          hello_body(2+32+1+32+2+ciphers+2+2+extensions)
    hello_body_len = (2 + 32 + 1 + 32 + 2 + len(cipher_bytes) + 2 + 2 + len(extensions_body))
    handshake_total = 1 + 3 + hello_body_len  # type(1) + len(3) + body
    current_len = 5 + handshake_total  # record_header + handshake
    padding_needed = max(0, target_total - current_len)
    # Ограничиваем паддинг разумным значением
    if padding_needed > 0 and padding_needed < 256:
        ext_padding = b"\x00\x15" + struct.pack("!H", padding_needed) + b"\x00" * padding_needed
        extensions_body += ext_padding

    # --- Собираем финальное сообщение ---
    extensions_len = struct.pack("!H", len(extensions_body))

    # ClientHello body
    hello_body = (
        b"\x03\x03" +          # legacy_version: TLS 1.2 (как у всех)
        client_random +         # случайные 32 байта
        bytes([32]) +           # session_id length
        session_id +            # случайный session ID
    ...
    # Handshake header
    handshake = b"\x01" + struct.pack("!I", len(hello_body))[1:]  # 3 байта длины

    # TLS record header
    record = b"\x16\x03\x01" + struct.pack("!H", len(handshake) + len(hello_body))

    return record + handshake + hello_body
...
async def do_direct_handshake(proto_tag, dc_idx, dec_key_and_iv=None):
    ...
    # ── MOD: Определяем CDN DC (6+) — требует особой обработки ──
    is_cdn_dc = (dc_idx >= 5)

    if my_ip_info["ipv6"] and (config.PREFER_IPV6 or not my_ip_info["ipv4"]):
        if not 0 <= dc_idx < len(TG_DATACENTERS_V6):
            dbg(f"[DC_SKIP] dc={raw_dc} (idx={dc_idx}) out of range for IPv6, skipping")
            return False
        dc = TG_DATACENTERS_V6[dc_idx]
    else:
        if not 0 <= dc_idx < len(TG_DATACENTERS_V4):
            dbg(f"[DC_SKIP] dc={raw_dc} (idx={dc_idx}) out of range, skipping")
            return False
        dc = TG_DATACENTERS_V4[dc_idx]

    # ── MOD: Для CDN DC — используем оригинальный IP, FAST_MODE включён ──
    if is_cdn_dc:
        cdn_dc_ips = getattr(config, 'CDN_DC_IPS', {})
        actual_dc_num = dc_idx + 1  # обратно в номер DC

        if actual_dc_num in cdn_dc_ips:
            cdn_ip = cdn_dc_ips[actual_dc_num]
            if isinstance(cdn_ip, list):
                dc = myrandom.choice(cdn_ip)
            else:
                dc = cdn_ip
            dbg(f"[CDN_DC] dc={raw_dc} → configured IP {dc}")
        else:
            dbg(f"[CDN_DC] dc={raw_dc} (idx={dc_idx}) → using table IP {dc}")

        # FAST_MODE остаётся включённым — CDN работает со сквозными ключами

    try:
        reader_tgt, writer_tgt = await tg_connection_pool.get_connection(dc, TG_DATACENTER_PORT)
    except ConnectionRefusedError as E:
        if is_cdn_dc:
            print_err(f"[CDN_DC] dc={raw_dc} connection refused to {dc}:{TG_DATACENTER_PORT} — CDN IP may be stale")
        else:
        ...
        if is_cdn_dc:
            print_err(f"[CDN_DC] dc={raw_dc} timeout/error connecting to {dc}:{TG_DATACENTER_PORT}: {E}")
        else:
...
async def tg_connect_reader_to_writer(rd, wr, user, rd_buf_size, is_upstream):
    direction = "clt→tg" if is_upstream else "tg→clt"
    total_bytes = 0
    chunks = 0
    # ── MOD: Адаптивный drain — автоматически подстраивается под состояние канала ──
    DRAIN_THRESHOLD_LOW = 4     # при хорошем канале — дренажим чаще (low latency)
    DRAIN_THRESHOLD_HIGH = 16   # при загруженном — реже (throughput)
    drain_every = DRAIN_THRESHOLD_LOW
    itr = 0
    t_start = time.time()
    try:
        while True:
            ...
            if not data:
                ...
                dbg(f"[{direction}] EOF user={user} total={total_bytes//1024}KB chunks={chunks} t={elapsed:.1f}s")
                wr.write_eof()
                await wr.drain()
                return
            else:
                ...
                if DEBUG_MODE and chunks % 50 == 0:
                    elapsed = time.time() - t_start
                    speed = total_bytes / elapsed / 1024 if elapsed > 0 else 0
                    buf_size = wr.transport.get_write_buffer_size()
                    dbg(f"[{direction}] user={user} {total_bytes//1024}KB speed={speed:.0f}KB/s buf={buf_size//1024}KB drain_every={drain_every} chunks={chunks}")

                wr.write(data, extra)
                itr += 1
                buf_size = wr.transport.get_write_buffer_size()
                if itr >= drain_every or buf_size > rd_buf_size * 8:
                    t0 = time.monotonic()
                    await wr.drain()
                    drain_dt = time.monotonic() - t0
                    itr = 0
                    # ── MOD: Адаптация — если drain медленный, канал деградирует ──
                    if drain_dt > 0.05:
                        drain_every = min(drain_every + 2, DRAIN_THRESHOLD_HIGH)
                    elif drain_dt < 0.01:
                        drain_every = max(drain_every - 1, DRAIN_THRESHOLD_LOW)
    except asyncio.TimeoutError as e:
        elapsed = time.time() - t_start
        print_err(f"[TIMEOUT {direction}] user={user} after {elapsed:.1f}s, {total_bytes//1024}KB transferred, TG_READ_TIMEOUT={config.TG_READ_TIMEOUT}s")
    except asyncio.IncompleteReadError as e:
        elapsed = time.time() - t_start
        dbg(f"[INCOMPLETE {direction}] user={user} after {elapsed:.1f}s, {total_bytes//1024}KB")
    except OSError as e:
        elapsed = time.time() - t_start
        print_err(f"[OSERROR {direction}] user={user} errno={e.errno} {e.strerror} after {elapsed:.1f}s, {total_bytes//1024}KB")


async def handle_client(reader_clt, writer_clt):
    clt_sock = writer_clt.get_extra_info("socket")
    set_keepalive(clt_sock, config.CLIENT_KEEPALIVE, attempts=3)
    set_ack_timeout(clt_sock, config.CLIENT_ACK_TIMEOUT)
    set_bufsizes(clt_sock, get_to_tg_bufsize(), get_to_clt_bufsize())
    # ── MOD: TCP_NODELAY на клиентском сокете — убирает Nagle's задержку для мелких пакетов ──
    try_setsockopt(clt_sock, socket.IPPROTO_TCP, socket.TCP_NODELAY, 1)
    ...
    proto_name = {b"\xef\xef\xef\xef": "abridged", b"\xee\xee\xee\xee": "intermediate",
                  b"\xdd\xdd\xdd\xdd": "secure"}.get(proto_tag, "unknown")
    dbg(f"[CONNECT] user={user} ip={cl_ip} dc={dc_idx} proto={proto_name} curr={user_stats[user]['curr_connects']}")
    ...
    if not tg_data:
        print_err(f"[NO_TG_CONN] user={user} ip={cl_ip} dc={dc_idx} — handshake to TG failed after {time.time()-t_conn:.2f}s")
        return
    dbg(f"[TG_CONN_OK] user={user} dc={dc_idx} in {time.time()-t_conn:.2f}s")

    reader_tg, writer_tg = tg_data

    # FAST_MODE для всех DC включая CDN — сквозные ключи
    ...
    if tcp_limit_hit:
        print_err(f"[LIMIT] user={user} ip={cl_ip} tcp_limit hit: {user_stats[user]['curr_connects']} conns")
    elif user_expired:
        print_err(f"[EXPIRED] user={user} ip={cl_ip}")
    elif user_data_quota_hit:
        print_err(f"[QUOTA] user={user} ip={cl_ip}")

    if (not tcp_limit_hit) and (not user_expired) and (not user_data_quota_hit):
        octets_before = user_stats[user]["octets_to_client"]
        start = time.time()
        done, pending = await asyncio.wait([task_tg_to_clt, task_clt_to_tg], return_when=asyncio.FIRST_COMPLETED)
        elapsed = time.time() - start
        octets_after = user_stats[user]["octets_to_client"]
        session_bytes = octets_after - octets_before
        dbg(f"[SESSION_END] user={user} ip={cl_ip} dc={dc_idx} duration={elapsed:.1f}s session={session_bytes//1024}KB total={octets_after//1024}KB")
        update_durations(elapsed)
...
async def handle_client_wrapper(reader, writer):
    ...
    try:
        ...
        dbg(f"[WRAPPER] CancelledError/IncompleteRead from {peer}")
    except ConnectionResetError:
        dbg(f"[WRAPPER] ConnectionReset from {peer}")
    except (TimeoutError, BrokenPipeError) as e:
        dbg(f"[WRAPPER] {type(e).__name__} from {peer}")
    except Exception as e:
        print_err(f"[WRAPPER_ERR] Unhandled {type(e).__name__} from {peer}: {e}")
        traceback.print_exc()
    finally:
        writer.transport.abort()
...
def print_tg_info():
    ...
    # === ИЗМЕНЕНИЕ 1 отражено здесь: порог предупреждения убран для 853 ===
    if config.PORT not in (853, 443):
        print("Non-standard port %d is used" % config.PORT, flush=True)
...
def try_setup_uvloop():
    # Нативный asyncio SOCKS5 полностью совместим с uvloop
    try:
        import uvloop
...
def create_utilitary_tasks(loop):
    ...
    # ── MOD: Health checker для SOCKS5 — мониторит задержку, чистит пул при деградации ──
    if config.SOCKS5_HOST and config.SOCKS5_PORT:
        health_task = asyncio.Task(socks5_health_checker(), loop=loop)
    ...
    while True:
        ...
        try:
            ...
            if consecutive_failures >= 3 and config.SOCKS5_HOST_BACKUP:
                print_err(f"[HEALTH] {consecutive_failures} consecutive failures, backup available at "
                          f"{config.SOCKS5_HOST_BACKUP}:{config.SOCKS5_PORT_BACKUP}")
